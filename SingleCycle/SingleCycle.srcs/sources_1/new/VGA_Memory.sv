...
module VGA_Memory(
    ...
    input wire logic [8:0] y_coordinate, // use these two to index into desired chunk
    ...
    initial begin 
        for (int i = 0; i < 52000; i = i + 1) begin 
            VGA_MEM_CHUNK_1[i] = 8'd0; 
        end 
        for (int i = 0; i < 52000; i = i + 1) begin 
            VGA_MEM_CHUNK_2[i] = 8'd0; 
        end 
        for (int i = 0; i < 52000; i = i + 1) begin 
            VGA_MEM_CHUNK_3[i] = 8'd0; 
        end 
        for (int i = 0; i < 52000; i = i + 1) begin 
            VGA_MEM_CHUNK_4[i] = 8'd0; 
        end 
        for (int i = 0; i < 52000; i = i + 1) begin 
            VGA_MEM_CHUNK_5[i] = 8'd0; 
        end 
        for (int i = 0; i < 52000; i = i + 1) begin 
            VGA_MEM_CHUNK_6[i] = 8'd0; 
        end 
    end 
